      ...
      <div className="relative w-full h-[100dvh]">
        <div className="w-full absolute flex justify-between px-3 items-center z-20">
          <Link to="/" className="flex">
            <img src="public/images/logo for website.png" className="w-14 h-14 border-2 rounded-full border-gray-600 mt-2 cursor-pointer" />
          </Link>
          <Link href="/" className=" cursor-pointer w-14 h-14 flex rounded-full border-2 bg-black border-blue-400 mt-2 justify-center items-center">
            {/* <UserRound className="w-8 h-8 rounded-full text-white" /> */}
            <img src="images/prem.jpg" className="rounded-full w-12 h-12" />
          </Link>
        </div>
        ...
        <div className="md:hidden flex justify-evenly fixed bottom-0 w-full h-20 text-white bg-gray-950 z-50">
